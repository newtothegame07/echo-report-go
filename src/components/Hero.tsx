      ...
      <div className="container relative z-10 mx-auto px-4 py-20">
        <div className="max-w-3xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4 animate-fade-in">
            <Button size="lg" className="text-lg px-8 shadow-lg hover:shadow-xl transition-all" onClick={() => scrollToSection("report")}>
              <MapPin className="mr-2 h-5 w-5" />
              Report Waste
            </Button>
            <Button size="lg" variant="outline" className="text-lg px-8" onClick={() => scrollToSection("track")}>
